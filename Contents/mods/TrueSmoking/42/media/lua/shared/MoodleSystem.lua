...
function MoodleSystem:new (playerNum, moodleId)
    local obj = {}
...
function SmokingMoodle:new(playerNum)
    local table = TrueSmoking:getPlayerReference(playerNum)
    local moodleImage = TrueSmoking.Options.UseNewMoodle and 'smoking_new' or 'smoking_old'
    local obj = MoodleSystem.new(self, playerNum, moodleImage)
    obj.table = table
    return obj
end
...
function SmokingMoodle:update()
    ...
    local table = TrueSmoking:getPlayerReference(self.playerNum)
    local item = table.Smokable
...
function NicotineMoodle:new(playerNum)
    local table = TrueSmoking:getPlayerReference(playerNum)
    local obj = MoodleSystem.new(self, playerNum, 'nicotine')
