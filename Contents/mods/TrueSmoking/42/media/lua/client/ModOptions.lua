...
options:addTickBox("PassiveSmoking", "Passive Puffing", true, "Enable passive puffing")
options:addSlider("PassiveMinTime",  getText("Passive Smoking Min Time"), 0, 60, 1, 45, getText("UI_options_UNIQUEID_slider_tooltip"))
options:addSlider("PassiveMaxTime",  getText("Passive Smoking Max Time"), 0, 120, 1, 100, getText("UI_options_UNIQUEID_slider_tooltip"))
