...
options:addSlider("PassiveMinTime",  getText("Passive Puffing Min Time"), 0, 60, 1, 20, getText("UI_options_UNIQUEID_slider_tooltip"))
options:addSlider("PassiveMaxTime",  getText("Passive Puffing Max Time"), 0, 120, 1, 40, getText("UI_options_UNIQUEID_slider_tooltip"))
